...
c_nodo::c_nodo(c_point down_p, c_point top_p){
...
void c_nodo::reorganize_region(int flag){
  ...
  /*R1*/this->hijos[0] = new c_nodo( c_point( this->d_l.x , (this->d_l.y + this->u_r.y)/2), c_point( (this->d_l.x + this->u_r.x)/2, this->u_r.y) );
  /*R2*/this->hijos[1] = new c_nodo( this->m_m, this->u_r);
  /*R3*/this->hijos[2] = new c_nodo( this->d_l, this->m_m);
  /*R4*/this->hijos[3] = new c_nodo( c_point( (this->d_l.x + this->u_r.x)/2 , this->d_l.y), c_point( this->u_r.x ,(this->d_l.y + this->u_r.y)/2) );
